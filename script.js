...
const EMBEDDED_DATA = {
  ...
  // ================================================
  //  REFRAIN 2 – « Nivike nguvu zako Bwana »  (2:23 → 2:44)
  // ================================================
  ...
  { t: 164.0, text: 'Uniongoze, Mwendo nimalize.' }, // corrigé : Uni ongoze → Uniongoze

  // ================================================
  //  SPOKEN WORD / PRIÈRE  (2:50 → 3:38)
  // ================================================
  { t: 170.1, text: 'Tuko mbele zako Eh Roho wa Mungu Muumbaji,' },
  { t: 179.3, text: 'Twataka kuongozwa nawe' },        // corrigé : Twa taka → Twataka
  { t: 184.4, text: 'Endelea kuziongoza hatua zetu mbele ili tusirudi nyuma tuifikie malengo yetu.' }, // corrigé : tuserudi → tusirudi, tui fikie → tuifikie
  ...
  { t: 250.5, text: 'Nikiwa na wewe, sitaogopa lolote, Bwana.' }, // corrigé : sita ofu → sitaogopa
  ...
  { t: 360.8, text: 'Ni wewe uliye niita' },        // corrigé : ni ita → niita
  { t: 365.2, text: 'Utaniweka nguvu, Milele yote.' }, // corrigé : Utani vika → Utaniweka
